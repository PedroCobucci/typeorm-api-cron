...
export class default1681332450763 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`NOTIFICACAO\` (\`id\` int NOT NULL AUTO_INCREMENT, \`descricao_notificacao\` varchar(255) NOT NULL, \`data_vencimento\` varchar(255) NOT NULL, \`atributo_notificacao\` varchar(255) NOT NULL, \`clienteId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
